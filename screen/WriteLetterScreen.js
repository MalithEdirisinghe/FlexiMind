...
//                     console.log('latter: ',currentLetterIndex);
//                     if (responseJson.defectiveness === "No defect found") {
//                         Alert.alert(
//                             'Response',
//                             `Defectiveness: ${responseJson.defectiveness}, Status: ${responseJson.status}`,
//                             [
...
//                                 {
//                                     text: 'Next', onPress: () => {
//                                         if (currentLetterIndex < vowelLetters.length - 1) {
...
//                         Alert.alert(
//                             'Response',
//                             `Expected: ${expectedResponses[currentLetterIndex]}, Got: ${responseJson.status}`,
//                             [
//                                 { text: 'Try Again', onPress: handleClear }
//                             ]
//                         );
...
//                 {category === 'vowel' && (
//                     <>
//                         <Text style={styles.card1Text}><Text style={{ color: "#4D86F7", fontSize: 45, fontWeight: '600' }}>Write</Text> {vowelLetters[currentLetterIndex]}</Text>
//                     </>
//                 )}

//                 {category === 'consonant' && (
//                     <>
//                         <Text style={styles.card1Text}><Text style={{ color: "#4D86F7", fontSize: 45, fontWeight: '600' }}>Write</Text> க்</Text>
//                     </>
//                 )}
