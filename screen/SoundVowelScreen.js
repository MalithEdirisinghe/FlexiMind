...
const SoundVowelScreen = ({ route }) => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.textTopic}>{renderText('TAMIL LETTER\n SOUNDS', 'தமிழ் எழுத்து \nஒலிகள்')}</Text>
            {category === 'vowel' ? (
                <>
                    <Text style={styles.vowelText}>{renderText('Vowel Letters', 'உயிர் \nஎழுத்துக்கள்')}</Text>
                </>
            ) : category === 'consonant' ? (
                <>
                    <Text style={styles.vowelText}>{renderText('Consonant Letters', 'மெய் \nஎழுத்துக்கள்')}</Text>
                </>
            ) : null}
